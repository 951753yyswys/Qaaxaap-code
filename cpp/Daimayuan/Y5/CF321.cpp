...
namespace Qaaxaap
{
	...
	int mp[4040][4040],dp[1010][5050],sum[4040][4040],su[4040][4040];
	...
	void work()
	{
		...
		for(int i=1;i<=n;i++) for(int j=1;j<=n;j++) su[i][j]=su[i-1][j]+su[i][j-1]+mp[i][j]-su[i-1][j-1];
		for(int i=1;i<=n;i++) for(int j=1;j<=i;j++) sum[j][i]=su[i][i]-su[i][j-1]-su[j-1][i]+su[j-1][j-1];
